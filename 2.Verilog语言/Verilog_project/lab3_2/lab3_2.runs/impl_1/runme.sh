...
HD_PWD='C:/Users/12204/Desktop/Verilog_project/lab3_2/lab3_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log divide_and_count.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source divide_and_count.tcl -notrace
