...
HD_PWD='C:/Users/12204/Desktop/Verilog_project/lab3_2/lab3_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divide_and_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divide_and_count.tcl
