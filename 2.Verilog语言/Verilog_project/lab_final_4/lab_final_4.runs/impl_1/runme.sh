...
HD_PWD='C:/Users/12204/Desktop/Verilog_project/lab_final_4/lab_final_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topset.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topset.tcl -notrace
