...
HD_PWD='C:/Users/12204/Desktop/Verilog_project/lab_final_4/lab_final_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topset.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topset.tcl
